...
<article class="module width_full">
    <sf:form modelAttribute="customer" method="post">
        <header><h3><spring:message code="customerVat.edit.form.title"/></h3></header>
        <div class="module_content">

            <!-- First row -->
            <fieldset style="width:48%; float:left; margin-right: 3%;">
                <label><spring:message code="customerVat.add.form.name"/>:</label>
                <sf:input path="name" cssStyle="width:92%;"/>
                <sf:errors path="name" cssClass="error_text"/>
            </fieldset>
            <fieldset style="width:48%; float:left;" >
                <label><spring:message code="customerVat.add.form.nip"/>:</label>
                <sf:input path="nip" cssStyle="width:92%;"/>
