...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    @Query("select new com.ajurasz.util.object.CityPostCode( address.city, address.postCode) from  Address address where address.city like %:cityName% group by city")
